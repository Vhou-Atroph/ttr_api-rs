...
fn real_doodle_render() {
    ...
    assert_eq!(doodle.render(256,rendition::Format::Png),String::from("https://rendition.toontownrewritten.com/render/64000302010102050001/doodle/256x256.png")) //Needs to be a real doodle in Blam Canyon, Toontown Central on the day it's tested.
}
#[test]
#[ignore]
fn latest_article() {
